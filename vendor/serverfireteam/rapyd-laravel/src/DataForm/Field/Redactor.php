...
class Redactor extends Field
{
  ...
  public function build()
  {
	...
	Rapyd::script("function elFinderBrowser (field_name, url, type, win) {" .
        ...
        'insertdatetime media table contextmenu paste '], convert_urls: false,toolbar:'insertfile undo redo | copy cut paste pastetext | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media | preview  code | fullpage forecolor backcolor'});");
        break;
