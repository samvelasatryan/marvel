...
class Gallery extends Field
{
  ...
  public function build()
  {
	...
	Rapyd::script("function elFinderBrowser (field_name, url, type, win) {" .
		      ...
		      "return false;" .
		      "}");
        Rapyd::script("tinymce.init({selector: '#".$this->name."', file_browser_callback : elFinderBrowser, plugins: ['image code visualblocks'],menubar: '', convert_urls: false,toolbar:' image visualblocks code'});");
        break;
